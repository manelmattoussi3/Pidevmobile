...
import Kais.mycompany.myapp.Service.ServiceCoach;
...
//s.setFgColor(0x77EE8CAE);
        ...
        getToolbar().addMaterialCommandToSideMenu("Ajouter Formation", FontImage.MATERIAL_ADD, e -> new AddFormationForm(home).show());
         ...
         getToolbar().addMaterialCommandToSideMenu("List Conseil", FontImage.MATERIAL_ALBUM, e -> new ShowListConseil(home).show());
