package Kais.mycompany.myapp;

//import Kais.mycompany.myapp.GUI.ListFormation;
//import Kais.mycompany.myapp.GUI.ListFormationForm;
...
public class MyApplication {
 ...
 Image img=theme.getImage("moi.jpg");
    ...
    public void start() {
      ...
      // Image img=theme.getImage("moi.jpg");
        Form home = new Home(current);
       /* Toolbar tb = home.getToolbar();
        tb.addMaterialCommandToSideMenu("ListFormation", FontImage.MATERIAL_NATURE, e -> showListFormation(home));
        tb.addMaterialCommandToSideMenu("A propos Formation", FontImage.MATERIAL_APPS, e -> showAddFormation(home));
        tb.addMaterialCommandToSideMenu("Map", FontImage.MATERIAL_MAP, e -> showMap(home));*/
        home.show();
    }
  ...
  /*  private void showListFormation(Form atras) {
    ...
    private void showAddFormation(Form atras) {
        try {
            ...
            FontImage musi = FontImage.createMaterial(FontImage.MATERIAL_ANDROID, s);
            ...
            tabs.addTab("A propos", musi, new TextArea("an art of sound in time that expresses ideas and "
            ...
            addformation.setLayout(new BorderLayout());
            addformation.add(BorderLayout.CENTER, tabs);
    ...
    private void showMap(Form atras) {
         Form hi = new Form("Native Maps Test");
         hi.getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e-> atras.showBack());
        ...
        cnt.addLongPressListener(e -> {
            ...
            ToastBar.showMessage("Received longPress at " + e.getX() + ", " + e.getY(), FontImage.MATERIAL_MAP);
        });
