...
public class ServiceConseil {
   public ArrayList<Conseil> conseil;
    ...
    public ArrayList<Conseil> ChercherTopic(String categoricons) {
        ArrayList<Conseil> conseil = new ArrayList<>();
        //ConnectionRequest con = new ConnectionRequest();
       
        String Url = "http://localhost/pidev-integration/web/app_dev.php/Projet/rechercherCmobile";
       Url=Url+"?categoricons="+categoricons;
        req.setUrl(Url);
        req.addResponseListener((NetworkEvent evt) -> {
             JSONParser j = new JSONParser();
            try {
               
                Map<String,Object> conseilsListJson = j.parseJSON(new CharArrayReader(new String(req.getResponseData()).toCharArray()));
            System.out.println(conseilsListJson);
            List<Map<String,Object>> list = (List<Map<String,Object>>) conseilsListJson.get("root");
            for(Map<String,Object> obj :list){
