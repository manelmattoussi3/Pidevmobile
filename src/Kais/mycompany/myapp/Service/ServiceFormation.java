 ...
 */
import Kais.mycompany.myapp.GUI.showListFormation;
...
import Kais.mycompany.myapp.utils.Statics;
...
public class ServiceFormation {
   ...
   public ArrayList<Formation> ChercherTopic(String categorie) {
        ArrayList<Formation> formation = new ArrayList<>();
        //ConnectionRequest con = new ConnectionRequest();
       
        String Url = "http://localhost/pidev-integration/web/app_dev.php/Projet/rechercherFmobile";
       Url=Url+"?categorie="+categorie;
        ...
        req.addResponseListener((NetworkEvent evt) -> {
            ...
            try {
                ...
                Map<String,Object> formationsListJson = j.parseJSON(new CharArrayReader(new String(req.getResponseData()).toCharArray()));
