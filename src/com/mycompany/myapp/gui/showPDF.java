...
public class showPDF extends Form {
    ...
    public showPDF(Formation formation){
     ...
     /*   FileSystemStorage fs = FileSystemStorage.getInstance();
        ...
        //  });
        //String a="http://localhost/pidev-integration/web/app_dev.php/Projet/pdff/"+ formation.getId();
        Button devGuide = new Button("Show PDF");
      ...
      //  current.add(back);
      //  current.addAll(devGuide,descriptionDetails );
        // current.add(tl.createConstraint().widthPercentage(20),back);
