...
import com.mycompany.myapp.service.ServiceSponsoring;
...
//pour pouvoir  y revenir  plus tard  en utilisant la méthode showBack
    public Accueil() {
        ...
        com.mycompany.myapp.service.CandidatService sp = new CandidatService();
             if (Connectivity.isConnected()) {
        ...
        com.mycompany.myapp.service.ServiceSponsoring Sponsoring = new ServiceSponsoring();
    }
