...
public class DetailEvenementForm extends BaseForm {
    String MAPS_KEY = "AIzaSyBKXNneTVr8yaKCVD_sCEFj9CNCtcU85V8";
 ...
 //--------------------------bch nfsrouh --------------------------------------//
        ...
        Label Lieu= new Label(evv.getLocalisation());
        ...
        public void actionPerformed(ActionEvent evt) {
          MapUI map = new MapUI();
                ...
                try{
                    Coord coord = getCoord(Lieu.getText());
        ...
        participer.addActionListener((e) -> {
            ...
            System.out.println("id current user = "+SessionManager.getId()+", id event = "+evv.getId());
