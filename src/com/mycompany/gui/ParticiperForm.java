...
public class ParticiperForm extends BaseForm {
    ...
    Label btnConfirmer;
    public ParticiperForm(Resources res,Evenement  evv) {
        ...
        swipe.hideTabs();
        addTab(swipe,res.getImage("maisonLogo.png"), evv.getTitle(),evv);
 ...
 //--------------------------bch nfsrouh --------------------------------------//
        ...
        ArrayList<Participation> ev=  new ArrayList<>();
            ev=evenementService.getParticpationByEvent(evv.getId());
        System.out.println("part by event = "+evenementService.getParticpationByEvent(evv.getId()));
            for(Participation participation : ev) {
              System.err.println("part by event = "+evenementService.getParticpationByEvent(evv.getId()));
              Display.getInstance().callSerially(() -> {}); 
        addButton(img,participation.getUsername(),participation.getTitre(),participation);
        btnConfirmer.addPointerPressedListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
                System.out.println("check");
                EvenementService e = EvenementService.getInstance();
                System.out.println("iduser = "+participation.getUser_id()+",idevenet ="+participation.getEvanement_id());
                Dialog.show("Confirmation","Voullez vous vraiment confirmer ?","OK",null);
                e.participerEvenement(participation.getUser_id(), participation.getEvanement_id());
            }
        });
 ...
 //--------------------------bch nfsrouh --------------------------------------//
    ...
    private void addButton(Image img, String title, String n, Participation pa) {
