...
public class ParticiperForm extends BaseForm {
    ...
    public ParticiperForm(Resources res,Evenement  evv) {
        ...
        swipe.hideTabs();
        addTab(swipe,res.getImage("stat.jpg"), evv.getTitle(),evv);
 ...
 //--------------------------bch nfsrouh --------------------------------------//
        ...
        btnConfirmer.addPointerPressedListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                System.out.println("iduser = "+participation.getUser_id()+",idevenet ="+evv.getId());
                Dialog.show("Confirmation","Voullez vous vraiment confirmer ?","OK",null);
                e.participerEvenement(participation.getUser_id(), evv.getId());
                
                //decreementer nbr total participants
