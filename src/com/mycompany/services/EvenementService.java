...
//                      e.setDescription(obj.get("description").toString());
    ...
    public void participerEvenement(int iduser, int idevent) {
        String url ="http://127.0.0.1:8000/api/evenement/confirmerParticpant?id="+iduser+"&id="+idevent;
        req.setUrl(url);
                NetworkManager.getInstance().addToQueueAndWait(req);
    ...
    public void envyerDemandeParticipation(int iduser,int idevenet) {
        String url="http://127.0.0.1:8000/api/evenement/envoyerDemande?id="+iduser+"&id="+idevenet;
           req.setUrl(url);
           NetworkManager.getInstance().addToQueueAndWait(req);
            ...
            con.addResponseListener(new ActionListener<NetworkEvent>() {
                ...
                public void actionPerformed(NetworkEvent evt) {
                    ...
                    Map<String, Object> user = (Map<String, Object>)obj.get("User");
                        ...
                        float idevent = Float.parseFloat(user.get("id").toString());
